This is a Minecraft style voxel game engine written in C# using an OpenGL wrapper with support for multiplayer and designed to be easily expanded with support for custom textures and modular code.
